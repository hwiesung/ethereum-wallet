...
export default class TokenDetail extends Component {
  constructor() {
    super();
    const ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1.amount !== r2.amount});
    ...
    this.state = {
      ...
      coin: 'ETH',
      tokens:[],
      dataSource: ds.cloneWithRows([{amount:1},{amount:10},{amount:100},{amount:1000},{amount:10},{amount:100},{amount:10}])
    };
  }
                        ...
                        renderRow={(rowData) =>
                          <View >
                            ...
                            <View style={{flexDirection:'row', height:60, alignItems:'center'}}>
                              <Image style={{marginLeft:8}} source={require('../../assets/icHistoryDwIn.png')}/>
